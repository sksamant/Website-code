...
if ( isset($_REQUEST['attachment']['name'])) {
    $attachment_name = $_REQUEST['attachment']['name'];
}

if ( isset($_REQUEST['attachment']['size'])) {
    $attachment_size = $_REQUEST['attachment']['size'];
}

if ( isset($_REQUEST['attachment']['type'])) {
    $attachment_type = $_REQUEST['attachment']['type'];
}
...
if ( isset($_REQUEST['file']['name'])) {
    $file_name = $_REQUEST['file']['name'];
}

if ( isset($_REQUEST['file_size'])) {
    $file_size = $_REQUEST['file_size'];
}

if ( isset($_REQUEST['path_to_file'])) {
    $path_to_file = $_REQUEST['path_to_file'];
}
...
if ( isset($_REQUEST['file2']['name'])) {
    $file2_name = $_REQUEST['file2']['name'];
}

if ( isset($_REQUEST['file2_size'])) {
    $file2_size = $_REQUEST['file2_size'];
}

if ( isset($_REQUEST['env_report'])) {
    $env_report = $_REQUEST['env_report'];
}
...
if ( isset($_REQUEST['vlink_color'])) {
    $vlink_color = $_REQUEST['vlink_color'];
}
else {
    $vlink_color = '';
}

if ( isset($_REQUEST['alink_color'])) {
    $alink_color = $_REQUEST['alink_color'];
}
else {
    $alink_color = '';
}

if ( isset($_REQUEST['style_sheet'])) {
...
if ( isset($_REQUEST['missing_field_redirect'])) {
    $missing_field_redirect = $_REQUEST['missing_field_redirect'];
}
else {
    $missing_field_redirect = '';
}

if ( isset($_REQUEST['missing_fields_redirect'])) {
    $missing_fields_redirect = $_REQUEST['missing_fields_redirect'];
}
else {
